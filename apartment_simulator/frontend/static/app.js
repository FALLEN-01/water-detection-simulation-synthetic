/**
 * Water Leak Detection — Live Dashboard (Apartment Building)
 * Pure socket.io client. All data comes from the backend.
 * Adapted for 50-unit building aggregate (~0-200 L/min flow)
 */
...
function handleDataUpdate(d) {
  ...
  // Building flow bar: use 200 L/min max (was 15 for household)
  bar('barFlow',   flow / 200 * 100)
